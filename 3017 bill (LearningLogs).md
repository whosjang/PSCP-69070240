...
```text
โจทย์ต้องการให้คำนวณจำนวนเงินที่ลูกค้าต้องชำระ โดยต้องคิดค่าอาหารรวมกับค่าบริการ และ vat ด้วย
```
...
```text
step1: ตั้งตัวแปรเก็บค่าอาหารเป็นจำนวนเต็ม
step2: ตั้งตัวแปรค่าบริการ ,ค่า vat, ผลรวมสุทธิ
step3: ตั้ง loop if, else ให้ค่าบริการอยู่ในข้อกำหนด
step4: ถ้าใช่ แสดงค่าอาหารรวมค่าบริการ และ vat
step5: ถ้าไม่ แสดงค่าอาหารรวมค่า vat
```
...
```text
เปลี่ยนจากตั้ง loop ให้ค่าบริการอยู่ในข้อกำหนด เป็นให้ค่าบริการที่ไม่ตรงตามข้อกำหนดเช่นต่ำกว่า 50 ปัดเป็น 50 และ เกิน 1000 เป็น 1000
```
