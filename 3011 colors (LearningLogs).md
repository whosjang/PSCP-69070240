...
```text
โจทย์ต้องการให้ผสมแม่สี 2 สี ผสมปล้วได้สีอะไร ถ้าไม่ใช่แม่สีให้แสดง error
```
...
```text
step1: ตั้งตัวแปรรับค่าสีทั้ง 2 สี
step2: ตั้ง loop if, elif ระหว่างสี 2 สีตามที่โจทย์กำหนด
step3: ถ้าตัวแปร1 and ตัวแปร2 เป็นสีแดง or เหลือง ให้แสดงสีส้ม ฯลฯ
step4: else ตัวแปร1 และ ตัวแปร2 ไม่ได้อยู่ในแม่สี ให้แสดง error
```
...
```text
เปลี่ยนจากกำหนดค่าสี 2 สีรวมกันได้สีใหม่ เป็นถ้าตัวแปร1 คือสีแดง แล้วตัวแปร2 คือสีเหลือง ผสมแล้วจะได้สีส้ม ถ้าตัวแปร1 คือสีแดง แล้วตัวแปร2 คือสีน้ำเงิน ผสมแล้วจะได้สีม่วง ฯลฯ และเพิ่มกรณีที่ตัวแปรทั้งสองเป็นสีเดียวกัน ผสมแล้วจะได้สีเดิม
```
...
```text
ผู้กรอกเผลอกด space bar ต่อท้าย
```
...
```text
ให้คำแนะนำเกี่ยวกับ test case ใหม่ ๆ
```
