...
```text
โจทย์ต้องการให้เราใช้สูตรแปลงค่าอุณหภูมิหน่วยนึงไปอีกหน่วยนึง
```
...
```text
step 1: ตั้งตัวแปร 3 แปร เพื่อรับค่าอุณหภูมิ, หน่วยอุณหภูมิของค่านั้น และหน่วยอุหภูมิที่ต้องการ
step 2: แปลงค่าอุณหภูมิหน่วยอื่นเป็นหน่วย Celsius
step 3: แปลงค่าอุณหภูมิในหน่วย Celsius ไปหน่วยที่ต้องการ
step 4: แสดงค่าอุณหภูมิพร้อมทศนิยม 2 ตำแหน่ง
```
...
```text
วิธีสุดท้ายที่ใช้จริงคือแผนแรก ใช้ return ในการหยุดการทำงานหากผู้ใช้งานป้อน input ที่ไม่อยู่ในระบบ
```
