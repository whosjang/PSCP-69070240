...
```text
โจทย์ต้องการให้รับค่าระบบสี RGB 2 ชุด แล้วนำค่าความเข้มของแต่ละสีมาหาค่าเฉลี่ยเพื่อคำนวณเป็นสีใหม่
```
...
```text
step1 : รับค่าสี มา 2 ชุด
step2 : หาค่าเฉลี่ยของค่าในแต่ละสี โดยปัดเศษให้เป็นจำนวนเต็ม
step3 : แสดงค่าสีใหม่
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก คือ รับค่าสีเข้ามา 2 ชุด ซึ่งแต่ละชุดมีอยู่ 3 สี แล้วจากนำค่าความเข้มของแต่ละสีทั้งสองชุดมาบวกกันแล้วหาร 2 ทั้ง 3 สี แล้วแสดงค่าทั้งสามโดยใช้ f string
```
